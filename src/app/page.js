      ...
      <MotionWrapper>
        <div className="bg-black/50  flex flex-col gap-8 p-4 backdrop-blur-xs text-white bg-blend-overlay text-2xl font-stretch-75% rounded-2xl">
          ...
          <p className="text-2xl p-2">
            -- Ray’s Kitchen blends traditional Puerto Rican flavors with a
            modern twist. Fresh ingredients, bold spices, and comfort food
            vibes.
          </p>
          <p>Check out the the Menu</p>
          <p className="font-thin ">
            Since we are just starting, we are offering a limited menu for now.
            5 items or less per order.
          </p>
